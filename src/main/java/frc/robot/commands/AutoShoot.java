...
public class AutoShoot extends CommandGroup {
  ...
  public AutoShoot(int balls) {
    ...
    // ON times[]
    addSequential(new IndexBall(0.5), times[balls]); // Inversely proportional constant
    ...
    addSequential(new DynamicShooting(), balls); // directly proportional constant
  }

  public AutoShoot() {
    addSequential(new RotationAlignment());  
    addSequential(new DistanceAlignment());
    addSequential(new DynamicShooting(), 3); // multiply this by a constant as well
  }
}
